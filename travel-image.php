   ...
   <div class="row">  <!-- start main content row -->
      ...
      <div class="col-md-9">  <!-- start main content column -->
         <ol class="breadcrumb">
           ...
           <li class="active"><?php include 'travel-data.php';
          echo $images[54] = 'title'; ?></li>
         </ol> 
         ...
         <div class="row">
             <div class="col-md-8">
                 ...
                 echo "<img border=0 alt='title' src='./images/travel/medium/".$images[$IDX]['path']."' width=550 height=550 >";
                 ?>
             </div>
            <div class="col-md-4">
               <div class="panel panel-primary">
                  <div class="panel-body">
                      ...
                      <p>By <a href="#"<?php echo $images[$IDX]['user'] ?></a></p>
                  <p>Taken in <a href="#"><?php echo $images[$IDX]['country']; ?></a></p>
                  <p><?php echo $images[$IDX]['description']; ?></p>
                   </div>
               </div>
            </div>
         </div>
